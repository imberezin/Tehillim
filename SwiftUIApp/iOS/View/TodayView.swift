...
//        }
    ...
    func buildUrlTo(calendarItem: CalendarItem) -> String {
    ...
    func buildSectionHeaders(index: Int) -> some View{
    ...
    func getItemTitle(index: Int, data: [[String: String]]) -> String{
    ...
    func getItemValue(index: Int, data: [[String: Any]]) -> String{
